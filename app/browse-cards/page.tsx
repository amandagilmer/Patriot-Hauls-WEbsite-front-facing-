...
export default function BrowseCardsPage() {
  ...
  const mockListings = [
    ...
    },
    {
      ...
      description: "Open deck for versatile hauling needs",
      price: 55,
      image: "/placeholder.svg?height=200&width=300",
      rating: 4.5,
      reviews: 67,
      location: "Irving, TX",
      operator: "Brotherhood Hauling",
      distance: "5.1 miles",
      available: true,
      features: ["Stake Pockets", "Tie-downs", "Wood Deck"],
    },
    {
      id: "6",
      title: "Horse Trailer",
      description: "Safe transport for your livestock",
      price: 85,
      image: "/placeholder.svg?height=200&width=300",
      rating: 4.9,
      reviews: 43,
      location: "Garland, TX",
      operator: "Patriot Livestock Transport",
      distance: "7.4 miles",
      available: true,
      features: ["Ventilation", "Rubber Mats", "Dividers"],
    },
  ]
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                  {mockListings.map((listing) => (
                    <div
                      key={listing.id}
                      className="bg-white border-2 border-[#E5E5E5] rounded-lg overflow-hidden hover:border-[#C41E3A]/20 hover:shadow-md transition-all"
                    >
                      {/* Image */}
                      ...
                      <div className="p-4 space-y-3">
                        <div>
                          <h3 className="text-lg font-bold font-['Oswald',_sans-serif] line-clamp-1">
                            {listing.title}
                          </h3>
                          <p className="text-[#4F5D75] text-sm font-['Roboto_Condensed',_sans-serif] line-clamp-2">
                            {listing.description}
                          </p>
                        </div>
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="text-sm font-medium truncate">{listing.operator}</div>
                        </div>
                        ...
                        <div className="flex gap-2 pt-2">
                          <Button
                            variant="outline"
                            size="sm"
                            className="flex-1 border-[#4F5D75] text-[#4F5D75] hover:bg-[#4F5D75] hover:text-white text-xs"
                          >
                            Details
                          </Button>
                          <Button
                            ...
                            className="flex-1 bg-[#C41E3A] hover:bg-[#C41E3A]/90 disabled:opacity-50 text-xs"
                          >
                            {listing.available ? "Book" : "N/A"}
                          </Button>
                        </div>
                      </div>
                    </div>
